...
# Install packages needed to build gems and node-based assets
...
# Install Node.js and Yarn for Tailwind CSS build
...
# Copy built artifacts: gems, application, and CSS builds
